UPDATE Template
SET Subject = 'Hagerty VIP Event Notification',
                  ...
                  <tr>
                    <td align="center" valign="top"><!-- BEGIN HEADER // -->
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                        <tr>
                          <td valign="top" class="headerContent"><img src="https://dl.dropboxusercontent.com/u/6761860/Hagerty_VIP-600xHeader_sm.png" style="max-width:600px; width:600px; height:91px;" id="headerImage" /></td>
                        </tr>
                      </table>
                    ...
                    <td align="center" valign="top"><!-- BEGIN BODY // -->
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                        <tr>
                          ...
                          <p><strong>Member Number:</strong> ${MemberNumber}<br />
                          ...
                          <h2>Service Event Information</h2>
                          <p><strong>Service Request: </strong>${SRNumber}<br />
                            ...
                            <strong>Destination: </strong>${SRDestination}<br />
                            <strong>Purchase Order: </strong>${PONumber}<br />
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="emailButton" style="border-radius: 3px; background-color: #BF1E2C;">
                      <tr>
                              <td align="center" valign="middle" class="emailButtonContent" style="padding-top:15px; padding-right:30px; padding-bottom:15px; padding-left:30px; color:#ffffff;">Assistance Hotline: ${DispatchPhone}</td>
                            </tr>
                          </table></td>
                        </tr>
                        <tr>
...
IF NOT EXISTS (SELECT * FROM ProgramConfiguration WHERE ProgramID = (SELECT ID FROM Program WHERE Name = 'Coach-Net') AND Name = 'ShowCanWeTextYou')
...
BEGIN
 ...
 VALUES ( (SELECT ID FROM Program WHERE Name = 'Coach-Net')

 , (SELECT ID FROM ConfigurationType WHERE Name = 'Application')

 , (SELECT ID FROM ConfigurationCategory WHERE Name = 'Rule')

 , NULL, NULL, 'ShowCanWeTextYou', 'Yes', 1, 1, getdate(), 'system', NULL, NULL

 )

END

IF NOT EXISTS (SELECT * FROM ProgramConfiguration WHERE ProgramID = (SELECT TOP 1 ID FROM Program WHERE Name = 'Hagerty') AND Name = 'ShowCanWeTextYou')

BEGIN

 INSERT ProgramConfiguration (ProgramID, ConfigurationTypeID, ConfigurationCategoryID, ControlTypeID, DataTypeID, Name, Value, IsActive, Sequence, CreateDate, CreateBy, ModifyDate, ModifyBy)

 VALUES ( (SELECT ID FROM Program WHERE Name = 'Hagerty')

 , (SELECT ID FROM ConfigurationType WHERE Name = 'Application')

 , (SELECT ID FROM ConfigurationCategory WHERE Name = 'Rule')

 , NULL, NULL, 'ShowCanWeTextYou', 'No', 1, 1, getdate(), 'system', NULL, NULL

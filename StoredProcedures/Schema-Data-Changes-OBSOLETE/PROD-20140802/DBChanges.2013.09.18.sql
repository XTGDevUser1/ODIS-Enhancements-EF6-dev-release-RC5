...
SET @SecurableID = (SELECT ID FROM Securable WHERE FriendlyName = 'MENU_LEFT_VENDOR_PORTAL_ACH')

DECLARE @VendorRole UNIQUEIDENTIFIER
SET @VendorRole = (SELECT RoleID FROM aspnet_Roles WHERE RoleName = 'VendorAdmin')

INSERT INTO AccessControlList VALUES(@SecurableID,@VendorRole,3)
------------------------------------------------------------------------------------------------------


DECLARE @EventCategoryID INT
SET @EventCategoryID = (SELECT ID FROM EventCategory WHERE Name = 'VendorPortal')

DECLARE @EventTypeID INT
SET @EventTypeID =     (SELECT ID FROM EventType WHERE Name = 'User')

IF NOT EXISTS(SELECT * FROM [Event] WHERE EventCategoryID = @EventCategoryID AND EventTypeID = @EventTypeID AND Name = 'ACHSignUpClicked')
BEGIN
INSERT INTO [Event]
           ([EventTypeID]
           ,[EventCategoryID]
           ...
           ,[CreateDate])
     VALUES
           (@EventTypeID, @EventCategoryID, 'ACHSignUpClicked', 'User clicked ACH signup button', 1, 1, NULL, NULL)
END

IF NOT EXISTS(SELECT * FROM [Event] WHERE EventCategoryID = @EventCategoryID AND EventTypeID = @EventTypeID AND Name = 'InsertACH')
BEGIN
INSERT INTO [Event]
           ([EventTypeID]
           ,[EventCategoryID]
           ...
           ,[CreateDate])
     VALUES
           (@EventTypeID, @EventCategoryID, 'InsertACH', 'Insert ACH record', 1, 1, NULL, NULL)
END

IF NOT EXISTS(SELECT * FROM [Event] WHERE EventCategoryID = @EventCategoryID AND EventTypeID = @EventTypeID AND Name = 'TurnOnACH')
BEGIN
INSERT INTO [Event]
           ([EventTypeID]
           ,[EventCategoryID]
           ...
           ,[CreateDate])
     VALUES
           (@EventTypeID, @EventCategoryID, 'TurnOnACH', 'Turn On ACH', 1, 1, NULL, NULL)
END
IF NOT EXISTS(SELECT * FROM [Event] WHERE EventCategoryID = @EventCategoryID AND EventTypeID = @EventTypeID AND Name = 'TurnOffACH')
BEGIN
INSERT INTO [Event]
           ([EventTypeID]
           ,[EventCategoryID]
           ...
           ,[CreateDate])
     VALUES
           (@EventTypeID, @EventCategoryID, 'TurnOffACH', 'Turn Off ACH', 1, 1, NULL, NULL)
END
IF NOT EXISTS(SELECT * FROM [Event] WHERE EventCategoryID = @EventCategoryID AND EventTypeID = @EventTypeID AND Name = 'UpdateACH')
BEGIN
INSERT INTO [Event]
           ([EventTypeID]
           ,[EventCategoryID]
           ...
           ,[CreateDate])
     VALUES
           (@EventTypeID, @EventCategoryID, 'UpdateACH', 'Update ACH record', 1, 1, NULL, NULL)
END

--Insert scripts for Comment type
IF NOT EXISTS(SELECT * FROM CommentType WHERE Name = 'Demographics')
BEGIN
	INSERT INTO [CommentType]
           ...
           ,[IsActive])
     VALUES
           ('Demographics', 'Demograhpics', 1, 1)
END

IF NOT EXISTS(SELECT * FROM CommentType WHERE Name = 'Services')
BEGIN
	INSERT INTO [CommentType]
           ([Name]
           ,[Description]
...
IF NOT EXISTS(SELECT * FROM CommentType WHERE Name = 'Contract')
BEGIN
	INSERT INTO [CommentType]
           ([Name]
           ,[Description]
...
IF NOT EXISTS(SELECT * FROM CommentType WHERE Name = 'VendorInvoice')
BEGIN
	INSERT INTO [CommentType]
           ([Name]
           ,[Description]
           ...
           ,[IsActive])
     VALUES
           ('VendorInvoice', 'VendorInvoice', 4, 1)
END

IF NOT EXISTS(SELECT * FROM CommentType WHERE Name = 'Complaint')
BEGIN
	INSERT INTO [CommentType]
           ([Name]
           ,[Description]
           ...
           ,[IsActive])
     VALUES
           ('Complaint', 'Complaint', 5, 1)
END 

IF NOT EXISTS(SELECT * FROM CommentType WHERE Name = 'Compliment')
BEGIN
	INSERT INTO [CommentType]
           ([Name]
           ,[Description]
           ...
           ,[IsActive])
     VALUES
           ('Compliment', 'Compliment', 6, 1)
END
 
IF NOT EXISTS(SELECT * FROM CommentType WHERE Name = 'Claim')
BEGIN
	INSERT INTO [CommentType]
           ([Name]
           ,[Description]

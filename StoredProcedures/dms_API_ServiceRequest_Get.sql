...
/****** Object:  StoredProcedure [dbo].[dms_API_ServiceRequest_Get]    Script Date: 06/21/2012 12:46:26 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dms_API_ServiceRequest_Get]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[dms_API_ServiceRequest_Get]
GO
/****** Object:  StoredProcedure [dbo].[dms_API_ServiceRequest_Get]    Script Date: 07/03/2012 17:56:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
-- EXEC  [dbo].[dms_API_ServiceRequest_Get] 1467
CREATE PROCEDURE [dbo].[dms_API_ServiceRequest_Get](

...
/****** Object:  StoredProcedure [dbo].[dms_BillingCallTransfers_Get]    Script Date: 01/11/2017 11:41:34 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dms_BillingCallTransfers_Get]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[dms_BillingCallTransfers_Get]
GO
...
CREATE PROCEDURE [dbo].[dms_BillingCallTransfers_Get]
...
select	@SQLString = @SQLString + 'or   v.IsTransferredCallToAAA   = ''1'' ) ' -- Customer Assistance

--
-- SETUP SCRIPT
-- Hagerty VIP service event notification
--



-- Insert new Event
IF NOT EXISTS (SELECT ID FROM Event WHERE Name = 'HagertyVIPIssuedPO')
BEGIN
	...
	VALUES ( 
			...
			, 'HagertyVIPIssuedPO'
			, 'Hagerty VIP Member Issued a PO'
			, 1
			, 1
			, 'system'
			, GETDATE()
...
IF EXISTS(SELECT ID FROM Template WHERE Name = 'Hagerty_VIPEventEmail')
BEGIN
	UPDATE Template SET Body='
                  ...
                  <tr>
                    <td align="center" valign="top"><!-- BEGIN PREHEADER // -->
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                        <tr>
                          <td valign="top" class="preheaderContent" style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:20px;">You are receiving this message because of an interaction with the Coach-Net Dispatch Center. If you think you have received this message in error please contact customer service. </td>
                  ...
                  <tr>
                    <td align="center" valign="top"><!-- BEGIN HEADER // -->
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                        <tr>
                          <td valign="top" class="headerContent"><img src="https://dl.dropboxusercontent.com/u/6761860/Hagerty_VIP-600xHeader_sm.png" style="max-width:600px;" id="headerImage" /></td>
                        </tr>
                      </table>
                  ...
                  <tr>
                    <td align="center" valign="top"><!-- BEGIN BODY // -->
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                        <tr>
                          <td valign="top" class="bodyContent"><h1>Attention: Hagerty VIP client has experienced a roadside assistance event</h1>
                            <h3>Please review the information below for details of the event</h3>
                          <p><strong>Customer Information:</strong></p>
                          <p><strong>Member Name:</strong> ${MemberName}<br />
                            <strong>Vehicle:</strong>  ${MemberVehicleDesc}<br />
                            <strong>Callback Number:</strong> ${MemberCallback}</p>
                          <p><strong>Service Event Information:</strong></p>
                          <p><strong>Service Request:</strong> ${SRNumber}<br />
                            <strong>Inbound Call: </strong> ${SRCallDateTime}<br />
                            <strong>Service Type:</strong> ${SRType}<br />
                            <strong>Location: </strong>${SRLocation}<br />
                            <strong>Destination:</strong> ${SRDestination}</p>
                          <p><strong>Purchase Order:</strong> ${PONumber}<br />
                            <strong>Issued: </strong> ${POIssueDateTime}<br />
                            <strong>Issued To:</strong> ${POVendor}<br />
                            <strong>ETA:</strong> ${SRETA}</p>
<table border="0" align="center" cellpadding="0" cellspacing="0" class="emailButton" style="border-radius: 3px; background-color: #BF1E2C;">
                    ...
                    <td align="center" valign="top"><!-- BEGIN FOOTER // -->
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                        ...
                        <tr>
                          ...
                          <em>Version: 1.0 Jan. 2015<br />
                          © 2015 Coach-Net. All rights reserved.</em> <br />
                            <br />
	...
	'
	where Name = 'Hagerty_VIPEventEmail'
END
-- Insert new Email Template
IF NOT EXISTS (SELECT ID FROM Template WHERE Name = 'Hagerty_VIPEventEmail')
BEGIN
	INSERT Template (Name, Subject, Body, IsActive, CreateDate, CreateBy, ModifyDate, ModifyBy)
	VALUES ('Hagerty_VIPEventEmail','Hagerty VIP Event Notification Email'
	, '
	<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
...
IF NOT EXISTS(SELECT * FROM EventTemplate where TemplateID = (Select ID FROM Template where Name ='Hagerty_VIPEventEmail') AND EventID = (SELECT ID FROM [Event] where Name='HagertyVIPIssuedPO'))
BEGIN
	INSERT INTO EventTemplate(EventID,TemplateID,IsDefault)
	VALUES(
		(SELECT ID FROM [Event] where Name='HagertyVIPIssuedPO'),
		(Select ID FROM Template where Name ='Hagerty_VIPEventEmail'),
		1
		)
END

-- Setup Subscription for new event
IF NOT EXISTS(
	SELECT * FROM EventSubscription where 
		EventID = (SELECT ID FROM Event WHERE Name = 'HagertyVIPIssuedPO') AND 
		ContactMethodID = (SELECT ID FROM ContactMethod WHERE Name = 'Email') AND
		EventTemplateID = (SELECT ID FROM EventTemplate WHERE TemplateID = (Select ID FROM Template where Name ='Hagerty_VIPEventEmail') AND EventID = (SELECT ID FROM [Event] where Name='HagertyVIPIssuedPO')) AND
		Email = 'rhancock@nmc.com'
)
BEGIN
	...
	VALUES (
			...
			, (SELECT ID FROM EventTemplate WHERE TemplateID = (Select ID FROM Template where Name ='Hagerty_VIPEventEmail') AND EventID = (SELECT ID FROM [Event] where Name='HagertyVIPIssuedPO'))
			, NULL 
			, NULL
			, 'rhancock@nmc.com'
			, 1

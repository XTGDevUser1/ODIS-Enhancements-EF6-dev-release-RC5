...
IF EXISTS (SELECT * FROM dbo.sysobjects 
 WHERE id = object_id(N'[dbo].[vw_ServiceRequestAgentTimeSummary]')   		AND type in (N'P', N'PC')) 
 BEGIN
 DROP VIEW [dbo].[vw_ServiceRequestAgentTimeSummary] 
 END 
 GO  
CREATE VIEW [dbo].[vw_ServiceRequestAgentTimeSummary]

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dms_BillingElectronicNotifications_Get]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[dms_BillingElectronicNotifications_Get]
GO

CREATE PROCEDURE [dbo].[dms_BillingElectronicNotifications_Get]
...
select	@SQLString = @SQLString + 'where 1=0 '

...
;(function($, window, document, undefined)
{
	...
	$.template.init = function()
	{
		...
		$('#open-menu').on('touchend click', function(event)
		{
            ...
            //sanghi
            $('#ui-tabs-2').trigger("resize");

            //NP 7/18: To redraw the graph on Dashboard on hiding and un-hiding the Side Menu
            if( $("#DispatchChart").data("kendoChart"))
            {               
                setTimeout(function(){  
                    $("#DispatchChart").data("kendoChart").refresh();   
                },300);             
            }            

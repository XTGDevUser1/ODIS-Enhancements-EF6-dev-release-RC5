     ...
     var methods = {
         ...
         */
         hidePrompt: function () {
             ...
             //KB: Fix when hiding prompts and the options is null.
             if (options == null) {
                 $(promptClass).fadeTo(0.3, 0.3, function () {
                     $(this).parent('.formErrorOuter').remove();
                     $(this).remove();
                 });
             }
             ...
             switch (field.prop("type")) {
                 ...
                 default:
                     ...
                     if (!$.trim(field.val()) || field.val() == field.attr("data-validation-placeholder")) {
                         // KB : Get the error_required attribute to present custom error messages
                         if (field.attr("error-required")) {
                             return field.attr("error-required");
                         }

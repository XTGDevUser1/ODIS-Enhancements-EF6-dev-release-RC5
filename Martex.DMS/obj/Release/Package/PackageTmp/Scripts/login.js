...
$(document).ready(function () {
    ...
    */
    ...
    // Switch
				formSwitch = $('<div id="form-switch" style="height:0px;width:0px"><span class="button-group"></span></div>').appendTo(formBlock).children(),
    ...
    */
    $('#form-login').submit(function (event) {
        ...
        var deviceName = $.trim($('#odisfield').val());
    ...
    */
    ...
    forms.each(function (i) {
        ...
        if (active) {
            ...
            // Height of viewport
            //KB: Adjust the height so that there is no gray area below the form. This gray area was due to the formSwitch placeholder.

            var formHeight = $(".input-wrapper").height();

            //formViewport.height(formHeight - formSwitch.height());
            formViewport.height("174px"); //KB: Hardcoded as there will be only form at a time.

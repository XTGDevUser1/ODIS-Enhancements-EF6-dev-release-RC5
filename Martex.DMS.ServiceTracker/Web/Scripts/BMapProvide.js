...
BingMaps.prototype = function () {
    ...
    //Qurey URLs
    var bingLocationApiUrl = "https://dev.virtualearth.net/REST/v1/Locations/";
    var bingSpatialApiUrl = "https://spatial.virtualearth.net/REST/v1/data/";
    var bingRoutesApiUrl = "https://dev.virtualearth.net/REST/v1/Routes/";
    var bingPhonebookApiUrl = "https://api.bing.net/json.aspx";
    ...
    var createDirectionsManagerCallback = function (locations) {
            ...
            this.directionsManager.setRenderOptions(
        {
            ...
            waypointPushpinOptions: { draggable: false, visible: false },
    ...
    var addPins = function (locations, hasInfobox, hasSetDestination, infoBoxOptions, optionalParams, icon) {
        // KB: Ensure that the API is loaded successfully before performing any operation
        if (typeof (Microsoft) != "undefined") {
            var mapLocations = $.map(locations, function (e) { return new Microsoft.Maps.Location(e.latitude, e.longitude); });
            for (var i = 0; i < mapLocations.length; i++) {
                var pin = new Microsoft.Maps.Pushpin(mapLocations[i], { icon: icon });
                ...
                if (hasInfobox) {
                    ...
                    else if (optionalParams != null && optionalParams.hasCustomizedBox != undefined && optionalParams.hasCustomizedBox) {

                        var setToDestButtonId = "InfoboxSetToDest" + this.infoboxSeed.toString();
                        infobox.contentDivId = "infobox" + (this.infoboxSeed++).toString();
                        infobox.setHtmlContent("<div id=\""
                    		+ infobox.contentDivId + "\" class=\"Infobox custom-infobox\" style=\"width :400px;\" ><a id=\""
                    		+ setToDestButtonId + "Anchor\" class=\"infobox-close\">x</a><div class=\"infobox-body\" style=\"background-color:white\"><div class=\"infobox-title\">"
                    		+ "<span style=\"background-color:blue; color:white;\"><span class=\"fa fa-car\"></span></span>" + locations[i].description + "</div></div><div class=\"infobox-button\"></div><div class=\"custom-infobox-stalk infobox-stalk\"></div></div>");

...
{
 public   class PhoneEntry: ExtendedEntry
    {
        ...
        public static readonly BindableProperty LastTextProperty =
            BindableProperty.Create("LastText", typeof(string), typeof(PhoneEntry), "");

        /// <summary>
        /// The font property
        /// </summary>
        public static readonly BindableProperty MaxLengthProperty =
            BindableProperty.Create("MaxLength", typeof(Int32), typeof(PhoneEntry), -1);
        ...
        //    BindableProperty.Create("Font", typeof(Font), typeof(PhoneEntry), new Font());

        /// <summary>
        /// The XAlign property
        /// </summary>
        public static readonly BindableProperty XAlignProperty =
            BindableProperty.Create("XAlign", typeof(TextAlignment), typeof(PhoneEntry),
                TextAlignment.Start);
        ...
        public static readonly BindableProperty HasBorderProperty =
            BindableProperty.Create("HasBorder", typeof(bool), typeof(PhoneEntry), true);

        /// <summary>
        /// The PlaceholderTextColor property
        /// </summary>
        public static readonly BindableProperty PlaceholderTextColorProperty =
            BindableProperty.Create("PlaceholderTextColor", typeof(Color), typeof(PhoneEntry), Color.Default);

        public static readonly BindableProperty CharacterMatchProperty =
            BindableProperty.Create("CharacterMatch", typeof(string), typeof(PhoneEntry), "");

        public static readonly BindableProperty TextLengthProperty =
            BindableProperty.Create("TextLength", typeof(Int32), typeof(PhoneEntry), -1);

        public static readonly BindableProperty SelectionEndProperty =
            BindableProperty.Create("SelectionEnd", typeof(Int32), typeof(PhoneEntry), -1);

        public static readonly BindableProperty SetSelectionProperty =
            BindableProperty.Create("SetSelection", typeof(SelectionPoint), typeof(PhoneEntry), new SelectionPoint(-1));

        public static readonly BindableProperty SelectionStartProperty =
            BindableProperty.Create("SelectionStart", typeof(Int32), typeof(PhoneEntry), -1);

        public static readonly BindableProperty MaskProperty =
            BindableProperty.Create("Mask", typeof(List<MaskRules>), typeof(PhoneEntry), null);

        //		public static read only BindableProperty MaxLengthProperty =
        //			BindableProperty.Create<PhoneEntry, Int32>(
        //				p => p.MaxLength, -1);
        public static readonly BindableProperty LockedProperty =
            BindableProperty.Create("Locked", typeof(bool), typeof(PhoneEntry), false);

        public static readonly BindableProperty DeleteProperty =
            BindableProperty.Create("Delete", typeof(bool), typeof(PhoneEntry), false);

        public static readonly BindableProperty FormatCharactersProperty =
            BindableProperty.Create("FormatCharacters", typeof(string), typeof(PhoneEntry), "");

        public static readonly BindableProperty RawTextProperty =
            BindableProperty.Create("RawText", typeof(string), typeof(PhoneEntry), "");
        ...
        public static readonly BindableProperty TextUpdateProperty =
            BindableProperty.Create("TextUpdate", typeof(string), typeof(PhoneEntry), "", propertyChanged: TextUpChanged);

        static void TextUpChanged(BindableObject bindable, object oldValue, object newValue)
        {
            PhoneEntry ctrl = (PhoneEntry)bindable;
        ...
        /// <summary>
        /// Text without formatting characters
        /// </summary>
            ...
            if (this.Mask != null)
            {
                if (this.Locked == false && (this.LastText != this.Text) && String.IsNullOrEmpty(this.Text) == false)
                {
                    ...
                    if (rule.Mask != "")
                    {
                        ...
                        finalText = temp;
                        //vary next = temp[start + adjustedStart-1];
                        this.LastText = temp;
                    }

...
namespace ODISMember.CustomControls.CardLayout
{
	public static class StyleKit
	{
		...
		public static class Status
		{
            ...
            public static Color CompletedColor = Color.Green;// Color.FromHex("00A2D3");
            public static Color CanceledColor = Color.Red; //Color.FromHex("E74C3C");
            public static Color InProgressColor = Color.Blue; //Color.FromHex("C5C5C5");
        }
		...
		public class Icons
		{
            ...
            public static FileImageSource ManSilhouette = new FileImageSource() { File = "ManSilhouette.png" };
        }
	}
}
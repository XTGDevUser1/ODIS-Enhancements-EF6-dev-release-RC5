...
namespace ODISMember.Droid.ResizeImage
{
    public class CropImageView : ImageViewTouchBase
    {
        ...
        private global::ODISMember.Droid.ResizeImage.HighlightView.HitPosition motionEdge;
        ...
        {
            CorpImage cropImage = (CorpImage)context;
            if (cropImage.Saving)
            {
                return false;
            }
            ...
            switch (ev.Action)
            {
                case MotionEventActions.Down:
                    ...
                    for (int i = 0; i < hightlightViews.Count; i++)
                    {
                        ...
                        if (edge != global::ODISMember.Droid.ResizeImage.HighlightView.HitPosition.None)
                        {
                            motionEdge = edge;
                            ...
                            mMotionHighlightView.Mode =
                                (edge == global::ODISMember.Droid.ResizeImage.HighlightView.HitPosition.Move)

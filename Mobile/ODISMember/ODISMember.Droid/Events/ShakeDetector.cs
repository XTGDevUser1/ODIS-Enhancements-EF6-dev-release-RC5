...
namespace ODISMember.Droid.Events
{
    public class ShakeDetector : Java.Lang.Object, ISensorEventListener
    {
        public const float SHAKE_THRESHOLD_GRAVITY = 2.7F;
        public const int SHAKE_SLOP_TIME_MS = 500;
        public const int SHAKE_COUNT_RESET_TIME_MS = 3000;

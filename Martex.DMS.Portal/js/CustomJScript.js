...
function AddressesGrid(grid) {
    ...
    this.getInsertedAddresses = function () {
        var insertedAddresses = this._grid.insertedDataItems();
    ...
    this.getUpdatedAddresses = function () {
        var updatedAddresses = this._grid.updatedDataItems();
    ...
    this.getDeletedAddresses = function () {
        ...
        var deletedAddresses = this._grid.deletedDataItems();
...
function IsUserInputValidForChange(combo) {
    ...
    var inputLength = combo.$text.val().length;

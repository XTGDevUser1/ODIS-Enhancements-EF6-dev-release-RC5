...
BingMaps.prototype = function () {
    ...
    //PROD KEYS
    var bingMapsKey = "Ag37nsHBx8BxsIiXtl5qxfYNY7tt6s-aKky73p8iYA3vdZ8NDx3YCC7L1WWAgCEK";
        ...
        return {
            ...
            directionsUpdatedHandler: function (e) {
                if (e != null && e.routeSummary != null && e.routeSummary.length > 0) {
                    callbackFunc(e.routeSummary[0].distance);
                }
            }
        };
    } ();
    ...
    var addPins = function (locations, hasInfobox, hasSetDestination) {
        ...
        for (var i = 0; i < mapLocations.length; i++) {
            ...
            if (locations[i].customIconUrl != null) {
                pin.setOptions({ icon: locations[i].customIconUrl });
            }

            if (hasInfobox) {
                var infobox = new Microsoft.Maps.Infobox(mapLocations[i], { visible: false });
    ...
    var getEntities = function (location, searchText) {
    ...
    var createSearchManagerCallback = function (location, searchText) {
        this.searchManager = new Microsoft.Maps.Search.SearchManager(this.map);
        return getEntities.bind(this, location, searchText)();
    }

    var searchBusiness = function (location, searchText) {
        var context = this;

        if (this.searchManager == null) {
            Microsoft.Maps.loadModule("Microsoft.Maps.Search", { callback: function () {
                createSearchManagerCallback.bind(context, location, searchText)();
            }
            });
        }
        else {
            getEntities.bind(this, location, searchText)();
        }
    }
